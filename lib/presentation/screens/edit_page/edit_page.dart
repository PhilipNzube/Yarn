      ...
      child: Consumer<EditPageController>(
        builder: (context, editPageController, child) {
          return Scaffold(
            ...
            body: editPageController.isUserDetailsLoading
                ? const Center(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                              height:
                                  (16.0 / MediaQuery.of(context).size.height) *
                                      MediaQuery.of(context).size.height),

                          // Personal Information Fields
                          TextFormField(
                            controller: editPageController.usernameController,
                            decoration:
                          ...
                          TextFormField(
                            controller: editPageController.firstnameController,
                            decoration:
                          ...
                          TextFormField(
                            controller: editPageController.surnameController,
                            decoration:
                          ...
                          TextFormField(
                            controller: editPageController.emailController,
                            decoration:
                                const InputDecoration(labelText: 'Email'),
                            onChanged: (value) =>
                                editPageController.setEmail(value),
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                          ...
                          SizedBox(
                              height:
                                  (16.0 / MediaQuery.of(context).size.height) *
                                      MediaQuery.of(context).size.height),
                          IntlPhoneField(
                            controller: editPageController.phoneController,
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            value: editPageController.selectedCountry,
                            ...
                            onChanged: (value) async {
                              ...
                              if (editPageController.selectedCountryIsoCode !=
                                  null) {
                          ...
                          PopupMenuButton<String>(
                            initialValue: editPageController.selectedState,
                            onSelected: (String value) async {
                              // Find the selected state based on the ISO code
                              csc.State? selectedState = editPageController
                                  .states
                              ...
                              if (selectedState != null) {
                                setState(() {
                                  ...
                                  editPageController.setSelectedState(
                                      selectedState
                                ...
                                if (editPageController.selectedStateIsoCode !=
                                    null) {
                          ...
                          SizedBox(
                              height:
                                  (16.0 / MediaQuery.of(context).size.height) *
                                      MediaQuery.of(context).size.height),
                          PopupMenuButton<String>(
                            initialValue: editPageController.selectedCity,
                            onSelected: (String value) {
                              editPageController.setSelectedCity(
